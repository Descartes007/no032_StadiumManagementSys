<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="订单单号" prop="dingdandanhao">
          <el-input v-model="ruleForm.dingdandanhao" 
              placeholder="订单单号" clearable  :readonly="ro.dingdandanhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="订单单号" prop="dingdandanhao">
              <el-input v-model="ruleForm.dingdandanhao" 
                placeholder="订单单号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="购买时间" prop="goumaishijian">
          <el-input v-model="ruleForm.goumaishijian" 
              placeholder="购买时间" clearable  :readonly="ro.goumaishijian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="购买时间" prop="goumaishijian">
              <el-input v-model="ruleForm.goumaishijian" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="退款原因" prop="tuikuanyuanyin">
          <el-input v-model="ruleForm.tuikuanyuanyin" 
              placeholder="退款原因" clearable  :readonly="ro.tuikuanyuanyin"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="退款原因" prop="tuikuanyuanyin">
              <el-input v-model="ruleForm.tuikuanyuanyin" 
                placeholder="退款原因" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="退款时间" prop="tuikuanshijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.tuikuanshijian" 
                type="datetime"
                :readonly="ro.tuikuanshijian"
                placeholder="退款时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.tuikuanshijian" label="退款时间" prop="tuikuanshijian">
              <el-input v-model="ruleForm.tuikuanshijian" 
                placeholder="退款时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  data() {
	...
	shouji : false,
	zhekou : false,
	tuikuanyuanyin : false,
	tuikuanshijian : false,
	crossuserid : false,
	crossrefid : false,
	sfsh : false,
	shhf : false,
  ...
  created() {
	this.ruleForm.tuikuanshijian = this.getCurDateTime()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='dingdandanhao'){
            this.ruleForm.dingdandanhao = obj[o];
	    this.ro.dingdandanhao = true;
            continue;
          }
          if(o=='qicaimingcheng'){
	    ...
	    this.ro.zhekou = true;
          ...
          if(o=='tuikuanyuanyin'){
            this.ruleForm.tuikuanyuanyin = obj[o];
	    this.ro.tuikuanyuanyin = true;
            continue;
          }
          if(o=='tuikuanshijian'){
            this.ruleForm.tuikuanshijian = obj[o];
	    this.ro.tuikuanshijian = true;
            continue;
          }
          if(o=='crossuserid'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `huiyuantuikuan/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.huiyuantuikuanCrossAddOrUpdateFlag = false;
						 this.parent.search();
