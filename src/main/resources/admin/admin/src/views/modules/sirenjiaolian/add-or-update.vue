<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="价格每小时" prop="jiagemeixiaoshi">
          <el-input v-model="ruleForm.jiagemeixiaoshi" 
              placeholder="价格每小时" clearable  :readonly="ro.jiagemeixiaoshi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="价格每小时" prop="jiagemeixiaoshi">
              <el-input v-model="ruleForm.jiagemeixiaoshi" 
                placeholder="价格每小时" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="职业履历" prop="zhiyelvli">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.zhiyelvli" label="职业履历" prop="zhiyelvli">
                    <span v-html="ruleForm.zhiyelvli"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xingbie = true;
          ...
          if(o=='jiagemeixiaoshi'){
            this.ruleForm.jiagemeixiaoshi = obj[o];
	    this.ro.jiagemeixiaoshi = true;
            continue;
          }
          if(o=='lianxifangshi'){
	...
	this.ruleForm.zhiyelvli = this.ruleForm.zhiyelvli.replace(reg,'../../../springboot3cprm/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `sirenjiaolian/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.sirenjiaolianCrossAddOrUpdateFlag = false;
						 this.parent.search();
