<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="退订原因" prop="tuidingyuanyin">
          <el-input v-model="ruleForm.tuidingyuanyin" 
              placeholder="退订原因" clearable  :readonly="ro.tuidingyuanyin"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="退订原因" prop="tuidingyuanyin">
              <el-input v-model="ruleForm.tuidingyuanyin" 
                placeholder="退订原因" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `qicaituiding/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.qicaituidingCrossAddOrUpdateFlag = false;
						 this.parent.search();
