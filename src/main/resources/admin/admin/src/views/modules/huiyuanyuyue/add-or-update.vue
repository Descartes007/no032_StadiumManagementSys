...
export default {
  ...
  computed: {
    zongjia:{
      get: function () {
        return 1*this.ruleForm.shijiage*this.ruleForm.shizhang*this.ruleForm.zhekou
      }
    },
  },
  created() {
...
var objcross = this.$storage.getObj('crossObj');
      ...
      if(objcross!=null) {
	      objcross.renci = objcross.renci - this.ruleForm.renci
	      if(objcross.renci<0){
		this.$message.error("人次不足");
		return
	      }
                }
	      this.$http({
