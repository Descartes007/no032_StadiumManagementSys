  ...
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.dingdandanhao" label="订单单号" prop="dingdandanhao">
              <el-input v-model="ruleForm.dingdandanhao" 
                placeholder="订单单号" readonly></el-input>
          </el-form-item>
        </div>
...
export default {
  ...
  computed: {
    zongjia:{
      get: function () {
        return 1*this.ruleForm.jiage*this.ruleForm.shuliang*this.ruleForm.zhekou
      }
    },
  },
  created() {
